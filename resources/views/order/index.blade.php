                                    ...
                                    <div class="col-12">
                                        <div class="row mx-4">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <input class="order-form-input" type="text" id="name-customer" placeholder="Full Name"  name="name" value="{{ old('name') }}">
                                        ...
                                        <div class="row mt-3 mx-4">
                                            ...
                                            <div class="col-12">
                                                <input class="order-form-input"  id="phone-customer" placeholder="Phone Number" type="tel" pattern="[0]{1}[0-9]{9}"  name="phone"  value="{{ old('phone') }}">
                                        ...
                                        <div class="row mt-3 mx-4">
                                            ...
                                            <div class="col-12">
                                                <input class="order-form-input"  id="address-customer" placeholder="Address" name="address"  value="{{ old('address') }}">
                                            </div>
                                        </div>
                                        <div class="row mt-3 mx-4">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <input class="order-form-input" id="mail-customer" placeholder="Email" type="email"  name="email"  value="{{ old('email') }}">
                                            </div>
                                        </div>
                                        <div class="row mt-3 mx-4">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <input class="order-form-input datepicker" placeholder="Selected date" type="text" id="date-picker-example"  name="date" value="{{ old('date') }}">
                                            </div>
                                        </div>
                                        <div class="row mt-3 mx-4">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <textarea class="form-control" id="note-order" rows="2" name="note"></textarea>
                                            </div>
                                        </div>
                                        <div class="row mt-3 mx-4">
                                            <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="order_total">
                                            <div class="order_total_content text-md-right">
                                                ...
                                                <span>$ </span><div id="order_total_amount">0</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
