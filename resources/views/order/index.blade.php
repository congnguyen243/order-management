                                        ...
                                        <div class="col-12">
                                            <div class="row mx-4">
                                                ...
                                                <div class="col-12 col-sm-6" style="padding-left: 7px;">
                                                    <input class="form-control" type="text" id="name-customer"
                                                        placeholder="Full Name" name="name" value="{{ old('name') }}">
                                                </div>
                                                <div class="col-12 col-sm-6 mt-2 mt-sm-0">
                                                    <input class="form-control" type="file" name="avatar" id="file-avatar">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3 mx-4">
                                                ...
                                                <div class="col-12">
                                                    <input class="form-control" id="address-customer" placeholder="Address"
                                                        ...
                                                        <div class="pl-md-0 pl-2 mx-5">
                                                            ...
                                                            <div class="form-outline">
                                                                ...
                                                                <input name="item[{{ $row->id }}]" disabled
                                                                    ...
                                                                    class="form-control quantity-product" value="0"
                                                                    min="1" />
                                                            </div>
                                                        </div>
