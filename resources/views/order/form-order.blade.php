                            ...
                            <div class="row mx-4">
                                ...
                                <div class="col-6 col-sm-6 mt-2 mt-sm-0" style="position: relative">
                                    <input class="order-form-input" id="edit-upload-order-avt" type="file"
                                        name="avatar">
                                    <img id="edit-order-avt" alt="img"
                                        src="{{ asset('/storage/' . $orderItem->avatar) }}"
                            ...
                            <div class="row mt-3 mx-4">
                                ...
                                <div class="col-12">
                                    <input class="order-form-input" placeholder="Phone Number" type="tel"
                                        pattern="[0]{1}[0-9]{9}" name="phone" value="{{ $orderItem->phone }}">
                            ...
                            <div class="row mt-3 mx-4">
                                ...
                                <div class="col-12">
                                    <input class="order-form-input datepicker" placeholder="Selected date" type="text"
                                        name="date" value={{ $orderItem->date }}>
                                </div>
                            </div>
                            <div class="row mt-3 mx-4">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control" rows="2" name="edit-order-form"
                                        id="edit-order-form">{!! $orderItem->note !!}</textarea>
                                </div>
                            </div>
                            <div class="row mt-3 mx-4">
                                <div class="col-12">
                            ...
                            <div class="row mt-3 mx-4">
                                <div class="col-12">
                                    <div class="form-check">
                                        ...
                                        <label for="validation" class="form-check-label">I know what I need to
                                            know</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12" id="wrap_item" style="height:500px; overflow:auto">
                            <div id="products-list">
                                @foreach ($dataProduct as $row)
                                    <div
                                        class="d-flex justify-content-between align-items-center mt-3 p-2 rounded item_order_edit">
                                        @foreach ($productOfOrder as $po)
                                            @if ($row->id == $po->product_id)
                                                <div class="col-6 d-flex flex-row">
                                                    <input type="checkbox" class="my-3 mx-2 item-check-selected"
                                                        value="{{ $row->price }}" checked>
                                                    <img alt="img" class="rounded" src="{{ asset($row->path) }}"
                                                        width="40">
                                                ...
                                                <div class="col-6 d-flex flex-row align-items-center">
                                                    ...
                                                    <div class="pl-md-0 pl-2 mx-5">
                                                        ...
                                                        <div class="form-outline">
                                                            <label class="form-label"
                                                                for="quantity-product-edit">Quantity </label>
                                                            <input name="item[{{ $row->id }}]" disabled
                                                                style="width: 70px;" type="number"
                                                                class="form-control quantity-product-edit" value="0"
                                                                min="1" />
                                                        </div>
                                                    </div>
                                                    <span class="d-block ml-5 font-weight-bold item-price">$
