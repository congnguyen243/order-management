                                    ...
                                    <div class="col-6 d-flex flex-row align-items-center">
                                        ...
                                        <div class="pl-md-0 pl-2">
                                            ...
                                            <div class="form-outline">
                                                ...
                                                <input name="item[{{$row->id}}]" style="width: 70px;" type="number"
                                                    class="form-control quantity-product-edit" value="{{$po->quantity}}"
                                                    min="1" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="pl-md-0 pl-2">
                                            ...
                                            <div class="form-outline">
                                                ...
                                                <input name="item[{{$row->id}}]" disabled style="width: 70px;"
                                                    type="number" class="form-control quantity-product-edit" value="0"
                                                    min="1" />
                                            </div>
                                        </div>
                                        <span class="d-block ml-5 font-weight-bold item-price">$ {{$row->price}}</span>
